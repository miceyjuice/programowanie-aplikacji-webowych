...
/***/ "./src/decorators/disabledState.ts":
/*!*****************************************!*\
  !*** ./src/decorators/disabledState.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, exports) => {

eval("\r\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\r\nexports.disabled = void 0;\r\nvar disabled = function (value) { return function (target, propertyKey) {\r\n    Object.defineProperty(target, propertyKey, { value: value });\r\n}; };\r\nexports.disabled = disabled;\r\n\n\n//# sourceURL=webpack://zad2/./src/decorators/disabledState.ts?");

/***/ }),

/***/ "./src/decorators/gameLogCounter.ts":
/*!******************************************!*\
  !*** ./src/decorators/gameLogCounter.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, exports) => {

eval("\r\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\r\nexports.gameLog = void 0;\r\nvar gameLog = function () { return function (target, name, descriptor) {\r\n    var originalMethod = descriptor.value;\r\n    var counter = 0;\r\n    descriptor.value = function () {\r\n        var args = [];\r\n        for (var _i = 0; _i < arguments.length; _i++) {\r\n            args[_i] = arguments[_i];\r\n        }\r\n        var result = originalMethod.apply(this, args);\r\n        counter++;\r\n        console.log(\"Licznik wywolania metody: \" + counter);\r\n        return result;\r\n    };\r\n}; };\r\nexports.gameLog = gameLog;\r\n\n\n//# sourceURL=webpack://zad2/./src/decorators/gameLogCounter.ts?");

/***/ }),

/***/ "./src/decorators/moveLogCounter.ts":
/*!******************************************!*\
  !*** ./src/decorators/moveLogCounter.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, exports) => {

eval("\r\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\r\nexports.moveCounter = void 0;\r\nvar moveCounter = function () { return function (target, name, descriptor) {\r\n    var originalMethod = descriptor.value;\r\n    var counter = 0;\r\n    descriptor.value = function () {\r\n        var args = [];\r\n        for (var _i = 0; _i < arguments.length; _i++) {\r\n            args[_i] = arguments[_i];\r\n        }\r\n        var result = originalMethod.apply(this, args);\r\n        counter++;\r\n        console.log(\"Ilosc ruchow: \" + counter);\r\n        return result;\r\n    };\r\n}; };\r\nexports.moveCounter = moveCounter;\r\n\n\n//# sourceURL=webpack://zad2/./src/decorators/moveLogCounter.ts?");
